  ...
  const efforts = [
    {
      ...
      hoursEach: 200,
      description: '5 weeks of discovery and planning',
      isOptional: true,
    },
    {
      component: 'Small Trades (< 100 hrs)',
      count: inputs.smallTrades,
      hoursEach: 40,
      description: 'Simple integrations and configurations',
      isOptional: false,
    },
    {
      component: 'Medium Trades (100-200 hrs)',
      count: inputs.mediumTrades,
      hoursEach: 120,
      description: 'Moderate complexity integrations',
      isOptional: false,
    },
    {
      component: 'Large Trades (200+ hrs)',
      count: inputs.largeTrades,
      hoursEach: 240,
      description: 'Complex custom integrations',
      isOptional: false,
    },
    {
      ...
      hoursEach: 80,
      description: 'Data infrastructure setup',
      isOptional: false,
    },
  ];
